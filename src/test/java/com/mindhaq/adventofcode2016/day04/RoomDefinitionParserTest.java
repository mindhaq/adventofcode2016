...
public class RoomDefinitionParserTest {
    ...
    public void reads_name() {
        Room room = roomDefinitionParser.fromCode(EXAMPLE1);
    ...
    public void it_parses_second_example() {
        Room room = roomDefinitionParser.fromCode(EXAMPLE2);
    ...
    public void it_parses_third_example() {
        Room room = roomDefinitionParser.fromCode(EXAMPLE3);
    ...
    public void it_parses_fourth_example() {
        Room room = roomDefinitionParser.fromCode(EXAMPLE4);
